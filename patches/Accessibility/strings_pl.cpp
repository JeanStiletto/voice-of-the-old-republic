...
const char* Get(Id id) {
    switch (id) {
        ...
        case Id::FmtMedPickerApplyTo:  return "Zastosuj na: %s";
        ...
        case Id::ActionRefused:           return "Niemo\xBFliwe.";
        ...
        case Id::FmtEquipStillEquipped: return "Przedmiot nadal za\xB3o\xBFony: %s";
        case Id::FmtWeaponSwitchedOne: return "Zmieniono bro\xF1: %s";
        case Id::FmtWeaponSwitchedTwo: return "Zmieniono bro\xF1: %s i %s";
        case Id::WeaponSwitchedBare:   return "Zmieniono bro\xF1";
        case Id::EquipSetActive:       return "aktywna";
        case Id::EquipSetSecondary:    return "zapasowa";
        ...
        case Id::WorkbenchPickerUnnamed:     return "Ulepszenie";
        case Id::WorkbenchUpgradeFailed:     return "Ulepszenie niemo\xBFliwe";
