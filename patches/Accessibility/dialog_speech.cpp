...
// Player Male" from "Twi'lek Female". Per-creature exceptions (Mission
// uses a Twi'lek appearance, Vrook uses N_CommM but is Cathar, etc.) are
// baked into the build-time classifier.
//
...
// then paste the constexpr block here. 344 human rows of 509.
