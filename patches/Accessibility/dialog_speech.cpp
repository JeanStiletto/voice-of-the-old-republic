...
// then paste the constexpr block here. 346 human rows of 509.
...
constexpr uint64_t kHumanAppearanceMask[kHumanAppearanceWordCount] = {
    0x00003e67deffedf0ULL,
    0xfffffffff8000000ULL,
    0xff3fffffffffffffULL,
    0x0000000fffffffffULL,
    0x181ffffff88003e0ULL,
    0x2c9f9ff87ffc3816ULL,
...
void Tick() {
    ...
    if (!bark) {
        ...
        if (text[0] != '\0' && std::strcmp(text, s_lastBarkText) != 0) {
            // Barks: the speaker is whoever the player is in dialog with;
            // for free-standing barks (passerby chatter) the player has
