...
const char* Get(Id id) {
    switch (id) {
        ...
        case Id::SpectatorBattleDoomed: return "I soldati della Repubblica sono perduti. Non puoi pi\xF9 aiutarli. Il percorso \xE8 bloccato. Affrettati verso il ponte!";
        ...
        case Id::MenuCatCombatBehaviour: return "Comportamento in combattimento";
        ...
        case Id::PlaceableStateCaptive:     return "prigioniero";
        case Id::PlaceableStateFreed:       return "liberato";
        case Id::PlaceableStateActive:      return "attivo";
        case Id::PlaceableStateDeactivated: return "disattivato";
        ...
        case Id::FmtEquipStillEquipped: return "Oggetto ancora equipaggiato: %s";
        case Id::FmtWeaponSwitchedOne: return "Armi cambiate: %s";
        case Id::FmtWeaponSwitchedTwo: return "Armi cambiate: %s e %s";
        case Id::WeaponSwitchedBare:   return "Armi cambiate";
        case Id::EquipSetActive:       return "attiva";
        case Id::EquipSetSecondary:    return "secondaria";
        ...
        case Id::DoorUnlocked:         return "sbloccata";
        ...
        case Id::FmtWorldStateOriented:       return "Direzione %s.\n%s.";
        case Id::FmtWorldStateUnknownCluster: return "Direzione %s.";
        ...
        case Id::ToggleOn:             return ", attivato";
        case Id::ToggleOff:            return ", disattivato";
        case Id::FmtSliderValueLabeled: return "%s %u di %u";
        case Id::FmtSliderValue:       return "%u di %u";
        case Id::EquipMenuName:        return "Equipaggiamento";
        ...
        case Id::FarAtNorth:                 return "molto a nord";
        case Id::FarAtSouth:                 return "molto a sud";
        case Id::FarAtEast:                  return "molto a est";
        case Id::FarAtWest:                  return "molto a ovest";
        ...
        case Id::FmtCraftCost:              return "Costa %d";
        case Id::FmtCraftYield:             return "Rende %d";
        ...
        case Id::WorkbenchPickerUnnamed:     return "Miglioramento";
        case Id::WorkbenchUpgradeFailed:     return "Miglioramento non possibile";
        ...
        case Id::FmtHelpNumberActions8:  return "8: applicare il %s corrente. Maiusc pi\xF9 8 apre la categoria per sceglierne un altro";
        ...
        case Id::HelpKeyPadCameraOrient:     return "Premi la levetta destra: ruota la telecamera verso il prossimo punto del radiofaro, altrimenti verso il punto cardinale successivo";
        ...
        case Id::KbNamePersonalKey5:        return "Azione personale 5";
        ...
        case Id::KbNameActionBarOpen5:      return "Apri barra azioni 5";
        ...
        case Id::KbNameCraftViewToggle:     return "Banco da lavoro crea o smonta";
