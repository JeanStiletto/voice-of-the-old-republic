...
const char* Get(Id id) {
    switch (id) {
        ...
        case Id::HintBackEntrance:    return "Entrada trasera";
        case Id::HintRebelCorpse:     return "Rebelde muerto";
        case Id::HintBanthaHerd:      return "Manada de banthas";
        case Id::MapNoteFrontExit:    return "Salida delantera";
        case Id::MapNoteBackExit:     return "Salida trasera";
        ...
        case Id::FmtTrapDetected:      return "Trampa detectada: %s";
        ...
        case Id::SpectatorBattleDoomed: return "Los soldados de la Rep\xFA""blica est\xE1n perdidos. Ya no puedes ayudarlos. El camino est\xE1 bloqueado. \xA1""Corre hacia el puente!";
        ...
        case Id::FmtMedPickerApplyTo:  return "Aplicar a: %s";
        ...
        case Id::ActionRefused:           return "No es posible.";
        ...
        case Id::PlaceableStateCaptive:     return "cautivo";
        case Id::PlaceableStateFreed:       return "liberado";
        case Id::PlaceableStateActive:      return "activo";
        case Id::PlaceableStateDeactivated: return "desactivado";
        ...
        case Id::FmtEquipStillEquipped: return "Objeto a\xFAn equipado: %s";
        case Id::FmtWeaponSwitchedOne: return "Armas cambiadas: %s";
        case Id::FmtWeaponSwitchedTwo: return "Armas cambiadas: %s y %s";
        case Id::WeaponSwitchedBare:   return "Armas cambiadas";
        case Id::EquipSetActive:       return "activa";
        case Id::EquipSetSecondary:    return "secundaria";
        ...
        case Id::DoorUnlocked:         return "desbloqueada";
        ...
        case Id::FmtWorldStateOriented:       return "Direcci\xF3""n %s.\n%s.";
        case Id::FmtWorldStateUnknownCluster: return "Direcci\xF3""n %s.";
        ...
        case Id::LevelUpGrantedPopupHint: return "Pulsa Intro para confirmar.";
        ...
        case Id::PortraitRaceTypeH:    return "tipo H";
        ...
        case Id::CombatLeaderAtPeace:        return "Fuera de combate";
        ...
        case Id::FarAtNorth:                 return "muy al norte";
        case Id::FarAtSouth:                 return "muy al sur";
        case Id::FarAtEast:                  return "muy al este";
        case Id::FarAtWest:                  return "muy al oeste";
        ...
        case Id::FmtCraftCost:              return "Cuesta %d";
        case Id::FmtCraftYield:             return "Devuelve %d";
        ...
        case Id::WorkbenchPickerUnnamed:     return "Mejora";
        case Id::WorkbenchUpgradeFailed:     return "Mejora no posible";
        ...
        case Id::ModSettingSupportModder:           return "Apoyar al modder";
        case Id::ModSettingLatestChanges:           return "\xDAltimos cambios";
        case Id::ModSettingOpenReadme:              return "Abrir la gu\xED" "a";
        case Id::ModSettingLinkOpened:              return "Abriendo en el navegador.";
        case Id::ModSettingLinkFailed:              return "No se ha podido abrir el enlace.";
        ...
        case Id::GlossaryEntrySwoopAligned:         return "Swoop en trayectoria";
        case Id::GlossaryEntrySwoopShiftReady:      return "Swoop cambio de marcha listo";
        ...
        case Id::HelpKeyMapCursor:       return "W, A, S y D: mover el cursor del mapa para leer el terreno y los marcadores";
        case Id::HelpKeyMapPosition:     return "Alt derecho: anunciar tu posici\xF3n y orientaci\xF3n en el mapa";
        case Id::HelpKeyPazaakNav:             return "Flechas: moverse entre tu mano, las dos mesas y las acciones. Enter juega la carta seleccionada";
        case Id::HelpKeyPazaakSign:            return "En una carta m\xE1s-menos: izquierda o derecha elige el signo, Enter la juega, Escape cancela";
        case Id::HelpKeyPazaakReview:          return "C: tu mano. T: las dos mesas. May\xFAs y C: cu\xE1ntas cartas le quedan al rival";
        case Id::HelpKeyPazaakTurn:            return "S: plantarse. E: terminar el turno";
        ...
        case Id::HelpKeyPadSelfStatus:       return "Gatillo izquierdo con X: tu propio estado";
        case Id::HelpKeyPadActionQueue:      return "Gatillo derecho con X: la cola de acciones. La cruceta arriba y abajo recorre las entradas, A quita la \xFAltima en cola, el gatillo izquierdo con A vac\xED" "a toda la cola, B cierra";
        ...
        case Id::KbNameCraftViewToggle:     return "Banco de trabajo crear o desmontar";
        ...
        case Id::FmtModLoadedVersion:   return "Voice of the Old Republic cargado, versi�n %s";
        case Id::FmtChargenFeatUnnamed: return "Dote %u";
        case Id::ChargenBtnRecommended: return "Recomendado";
        case Id::ChargenBtnAccept:      return "Aceptar";
        case Id::ChargenBtnBack:        return "Atr�s";
